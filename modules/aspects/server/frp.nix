# frp tunnel — exposes services running on prime (behind Hetzner's NAT)
# via *.tunnel.peeraten.net wildcard DNS. ACME cert for the wildcard
# issued via Cloudflare DNS-01; caddy terminates TLS on the wildcard.
#
# Replaces nix/hosts/prime/modules/frp.nix.
{ ... }:
{
