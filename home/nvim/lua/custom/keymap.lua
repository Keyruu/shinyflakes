...
vim.keymap.set('n', '-', ':Oil<CR>', { desc = 'Oil [-] File Browser' })
...
vim.keymap.set('n', '<leader>fh', '<cmd>Telescope help_tags<cr>', { desc = 'Telescope [h]elp tags' })
...
vim.keymap.set('n', '<leader>s', [[:%s/<<C-r><C-w>>/<C-r><C-w>/gI<Left><Left><Left>]], { desc = 'Rewrite only word nothing else' })
